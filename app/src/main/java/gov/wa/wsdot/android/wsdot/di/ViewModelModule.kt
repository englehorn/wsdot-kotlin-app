...
import gov.wa.wsdot.android.wsdot.ui.ferries.vesselwatch.TerminalViewModel
...
abstract class ViewModelModule {
    ...
    abstract fun bindTerminalViewModel(terminalViewModel: TerminalViewModel): ViewModel
